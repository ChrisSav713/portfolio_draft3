...
const user = {
  name: 'Christopher Savasta',
  email: 'ChrisSav713@gmail.com'
}
const navigation = [
  ...
  return (
    <>
      <div className='min-h-full'>
        <div className='bg-gradient-to-r from-slate-400 to-slate-600 pb-32'>
          <Disclosure
            as='nav'
            className='z-50 fixed top-0 left-0 right-0 border-b border-gradient-to-r from-slate-400 to-slate-600 border-opacity-25 bg-gradient-to-r from-slate-400 to-slate-600 lg:border-none'
          >
            {({ open }) => (
              <>
                <div className='mx-auto max-w-7xl px-2 sm:px-4 lg:px-8'>
                  <div className='relative flex h-16 items-center justify-between lg:border-b lg:border-gradient-to-r from-slate-400 to-slate-600 lg:border-opacity-25'>
                    {/* Flex middle */}
